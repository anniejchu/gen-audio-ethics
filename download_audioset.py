...
From https://github.com/speedyseal/audiosetdl/blob/master/download_audioset.py
...
if __name__ == '__main__':
    ...
    with YoutubeDL() as ydl:
        # vid=ydl.download(['https://www.youtube.com/watch?v=BaW_jenozKc'])
        info = ydl.extract_info('https://www.youtube.com/watch?v=EDwb9jOVRtU', download=False)
    
    download_yt_video('rfbb4yRBH64', 0, 10, '/media/willie/1caf5422-4135-4f2c-9619-c44041b51146/audio_data/debug/', './bin/ffmpeg/ffmpeg', './bin/ffmpeg/ffprobe',
                      audio_codec='flac', audio_format='flac',
                      audio_sample_rate=48000, audio_bit_depth=16,
                      video_codec='h264', video_format='mp4',
                      video_mode='bestvideoaudio', video_frame_rate=30,
